...
#define X_bias -16.67581776
#define Y_bias -15.25116822
#define Z_bias 6.643107477


#define NOPS_FOR_20_MS 12500
#define sample_size 150
#define tau 0.02 // sample rate of 20 ms
...
int main(int argc, char** argv) {
    ...
    TIMERS_Init();
    while (1) {
        if (TIMERS_GetMilliSeconds() - start_time == 20) {
            start_time = TIMERS_GetMilliSeconds();
#ifdef ACCEL_data
