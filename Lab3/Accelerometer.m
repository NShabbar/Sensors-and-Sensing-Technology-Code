...
% Get the Z matrix
F = A\B; % NOTE: This is not division, this is (A^t * A)^-1 * A^t * B
...
eq1 = -2*x0 == F(1);
eq2 = a^2/b^2 == F(2);
eq3 = ((-2*a^2)/b^2)*y0 == F(3);
eq4 = (a^2/c^2) == F(4);
eq5 = ((-2*a^2)/c^2) *z0 == F(5);
eq6 = x0^2+((y0^2*a^2)/b^2) -a^2*R^2 == F(6);
sol = solve([eq1, eq2, eq3, eq4, eq5, eq6],[x0,y0,z0, a, b, c]);
